...
namespace _WINFORM_QUẢN_LÝ_THƯ_VIỆN {
    ...
    public partial class QLTVDataSet : global::System.Data.DataSet {
        ...
        public partial class tacgiaDataTable : global::System.Data.TypedTableBase<tacgiaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public tacgiaRow AddtacgiaRow(int id, string name, string address, System.DateTime Bdate) {
        ...
        public partial class tacgiaRow : global::System.Data.DataRow {
            ...
            public string name {
                get {
                    try {
                        return ((string)(this[this.tabletacgia.nameColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'name\' in table \'tacgia\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tabletacgia.nameColumn] = value;
                }
            }
            ...
            public bool IsnameNull() {
                return this.IsNull(this.tabletacgia.nameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetnameNull() {
                this[this.tabletacgia.nameColumn] = global::System.Convert.DBNull;
            }
...
namespace _WINFORM_QUẢN_LÝ_THƯ_VIỆN.QLTVDataSetTableAdapters {
    ...
    public partial class tacgiaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[tacgia] WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_Bdate = 1 AND [Bdate] IS NULL) OR ([Bdate] = @Original_Bdate)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tacgia] ([id], [name], [address], [Bdate]) VALUES (@id, @name," +
                " @address, @Bdate);\r\nSELECT id, name, address, Bdate FROM tacgia WHERE (id = @id" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tacgia] SET [id] = @id, [name] = @name, [address] = @address, [Bdate] = @Bdate WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_Bdate = 1 AND [Bdate] IS NULL) OR ([Bdate] = @Original_Bdate)));
SELECT id, name, address, Bdate FROM tacgia WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, address, Bdate FROM dbo.tacgia";
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_address, global::System.Nullable<global::System.DateTime> Original_Bdate) {
        ...
        public virtual int Insert(int id, string name, string address, global::System.Nullable<global::System.DateTime> Bdate) {
        ...
        public virtual int Update(int id, string name, string address, global::System.Nullable<global::System.DateTime> Bdate, int Original_id, string Original_name, string Original_address, global::System.Nullable<global::System.DateTime> Original_Bdate) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string address, global::System.Nullable<global::System.DateTime> Bdate, int Original_id, string Original_name, string Original_address, global::System.Nullable<global::System.DateTime> Original_Bdate) {
            return this.Update(Original_id, name, address, Bdate, Original_id, Original_name, Original_address, Original_Bdate);
        }
    }
